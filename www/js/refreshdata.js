function refresh_solar() {
    $.getJSON("json.php", {'action': 'stats'},
        function(data){
            ...
            $("#solar_loading").hide();
            $("#stats_solar table").show();
        }
    );
}

function refresh_resol() {
...
setInterval(refresh_all, 1000 * 60 * 5); // Every 5 minutes

$(refresh_solar); // Fetch solar data on page load, to improve speeds
